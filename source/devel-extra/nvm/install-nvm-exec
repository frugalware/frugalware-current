...
<link rel='vcs-git' href='https://aur.archlinux.org/(null).git/' title='aur.git Git repository'/>
</head>
<body>
...
<tr>
<td class='main'>AUR</td></tr>
<tr><td class='sub'>AUR Package Repositories</td></tr></table>
<table class='tabs'><tr><td>
<a href='/cgit/aur.git/about/'>about</a><a href='/cgit/aur.git/'>summary</a><a href='/cgit/aur.git/log/'>log</a><a href='/cgit/aur.git/tree/'>tree</a><a href='/cgit/aur.git/commit/'>commit</a><a href='/cgit/aur.git/diff/'>diff</a><a href='/cgit/aur.git/stats/'>stats</a></td><td class='form'><form class='right' method='get' action='/cgit/aur.git/log/'>
<select name='qt'>
...
<div class='content'><div class='error'>Repository seems to be empty</div>
</div> <!-- class=content -->
<div id="footer">
	<p>
