...
up2date="lynx -dump http://releases.compiz-fusion.org/$compizver/ | grep $_F_compiz_name | Flasttarbz2"
source=(http://releases.compiz-fusion.org/$compizver/$_F_compiz_name-$pkgver.tar.bz2)
