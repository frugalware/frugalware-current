...
up2date="lynx -dump http://ftp.frugalware.org/pub/frugalware/frugalware-current/$repo/frugalware-i686/ |grep '$ename-[^-]*-[^-]*-$earch.fpm$'|grep -v 'mingw'|sed -n 's/.*$ename-\(.*\)-[^-]*-$earch.fpm/\1/;$ p'"
