...
up2date="lynx -dump http://code.google.com/p/$_F_googlecode_name/downloads/list|grep -m1 '$_F_googlecode_dirname\(.*\)$_F_googlecode_ext'|sed 's/.*$_F_googlecode_dirname\(.*\)$_F_googlecode_ext.*/\1/;s/-/_/g;s/_//1'"
