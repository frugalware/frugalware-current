...
[ -z "$_F_perl_no_up2date" ] && up2date="lynx -dump https://metacpan.org/pod/$(echo $_F_perl_name | sed 's/-/::/g') | grep https | grep -om1 '$_F_perl_name-\(.*\)$_F_perl_ext' | sed 's/.*-\(.*\)$_F_perl_ext/\1/'"
