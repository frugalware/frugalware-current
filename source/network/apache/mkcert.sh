...
##  hacked without style for httpd/conf by Robert Stan <robalo@linuxpackages.net>
...
sslcrtdir="/etc/httpd/conf"
sslcsrdir="/etc/httpd/conf"
sslkeydir="/etc/httpd/conf"
sslprmdir="/etc/httpd/conf"
...
case $type in
    ...
    dummy)
        ...
        echo ""
        echo "o  ${T_MD}conf/server.key${T_ME}"
        ...
        echo ""
        echo "o  ${T_MD}conf/server.crt${T_ME}"
...
EOT
        ...
        echo "   when you install via APACI)."
        echo ""
        echo "o  ${T_MD}conf/server.csr${T_ME}"
