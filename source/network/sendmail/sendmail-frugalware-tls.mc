dnl# This is the a sendmail .mc file for FrugalWare with TLS support.
...
dnl#
dnl# cp sendmail-frugalware-tls.mc /usr/share/sendmail/cf/config.mc
...
dnl#
include(`../m4/cf.m4')
VERSIONID(`TLS supporting setup for FrugalWare Linux')dnl
OSTYPE(`linux')dnl
dnl#
